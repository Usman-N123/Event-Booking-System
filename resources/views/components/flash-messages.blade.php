@if (session()->has('success'))
    <div x-data="{ show: true }" 
         ...
         class="fixed bottom-4 right-4 z-50 rounded-md bg-green-50 p-4 shadow-lg border border-green-200">
...
@if (session()->has('error'))
    <div x-data="{ show: true }" 
         x-show="show" 
         x-transition.duration.500ms
         class="fixed bottom-4 right-4 z-50 rounded-md bg-red-50 p-4 shadow-lg border border-red-200">
        <div class="flex items-center">
